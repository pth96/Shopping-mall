...
public class ProductUpdateProcessSerivce {

	public String productupdateprocess(HttpServletRequest request, HttpServletResponse response) throws IOException {
       String savePath = "E:\\source\\servlet\\Project\\WebContent\\Uploadfile";
        ...
        pDAO.dbConnection();
        int pupResult = pDAO.productupdateprocess(pDTO);
        pDAO.dbClose();
