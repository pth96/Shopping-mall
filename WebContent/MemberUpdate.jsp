...
<div id="wrap">
        <br><br>
        <b><font size="6" color="gray">내정보 수정</font></b>
        <br><br><br>
        <form action="memberupdateprocess" method="post" name="updateform">
            <table>
                <tr>
                    <td id="title">아이디</td>
                    <td>
                      <input type="text" name="mid" id="mid" value="${memberupdate.mid}" readonly> 
                    </td>
                </tr>
                ...
                <tr>
                    <td id="title">이름</td>
                    <td>
                       <input type="text" name="mname" id="mname" value="${memberupdate.mname}">                   
                    </td>
                </tr>
                ...
                <tr>
                    <td id="title">생년월일</td>
                    <td>
                       <input type="date" id="mbirth"name="mbirth" value="${memberupdate.mbirth}" readonly>
                    </td>
                </tr>
                ...
                <tr>
                    <td id="title">주소</td>
                    <td>
                        <input type="text" name="mpostnum" id="sample4_postcode" value="${memberupdate.mpostnum}" placeholder="우편번호">
        ...
        <input type="text" name="maddress1" id="sample4_extraAddress" value="${memberupdate.maddress1} "placeholder="참고항목">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="mphone" id="mphone" value="${memberupdate.mphone}" onkeyup="phoneCheck()"><br>
                ...
                <tr>
                    <td id="title">이메일</td>
                    <td>
                        <input type="text" name="memail" id="memail" value="${memberupdate.memail}">
                    </td>
                </tr>          
            </table>
